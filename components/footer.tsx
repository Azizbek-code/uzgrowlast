...
const footerLinks = {
  xizmatlar: [
    { label: "Turnkey issiqxona", href: "/xizmatlar" },
    { label: "Agro-injiniring", href: "/xizmatlar" },
    { label: "Jihozlar", href: "/texnologiya" },
    { label: "Agro-konsalting", href: "/xizmatlar" },
  ],
  kompaniya: [
    { label: "Biz haqimizda", href: "/haqimizda" },
    { label: "Loyihalar", href: "/loyihalar" },
    { label: "Texnologiya", href: "/texnologiya" },
    { label: "Investorlar", href: "/investorlar" },
  ],
  yordam: [
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <span className="text-xs text-white/50 tracking-wider">AGRO-INJINIRING</span>
              </div>
            </Link>
            <p className="text-white/70 mb-6 max-w-sm leading-relaxed">
              O&apos;zbekistonda zamonaviy issiqxona qurish va agro-injiniring xizmatlari. 
              Biz bilan kelajak bugun boshlanadi.
            </p>
            
            {/* Contact Info */}
            <div className="space-y-3">
              <a href="tel:+998555152233" className="flex items-center gap-3 text-white/70 hover:text-primary transition-colors">
                <Phone className="w-4 h-4" />
                <span>+998 55 515 22 33</span>
              </a>
              <a href="mailto:uzgrow@gmail.com" className="flex items-center gap-3 text-white/70 hover:text-primary transition-colors">
                <Mail className="w-4 h-4" />
                <span>uzgrow@gmail.com</span>
              </a>
              <div className="flex items-start gap-3 text-white/70">
                <MapPin className="w-4 h-4 mt-1 shrink-0" />
                <span>Toshkent sh., Yangihayor tumani, Fayzli MFY, Rayhon ko&apos;chasi, 107-uy</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            {/* Social Links */}
            <div className="mt-8">
              <h5 className="font-medium mb-4 text-sm text-white/50">Bizni kuzating</h5>
        ...
        <div className="container mx-auto px-4 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-white/50">
              &copy; {new Date().getFullYear()} UZ-GROW. Barcha huquqlar himoyalangan.
            </p>
            <p className="text-sm text-white/50">
