...
import { TrendingUp, Clock, Shield, Globe, Sprout, Download, ArrowRight, CheckCircle2 } from "lucide-react"
...
export function Investors() {
  return (
    <section id="investorlar" className="py-20 lg:py-32 bg-gradient-to-b from-muted/30 to-background relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            UZ-GROW yuqori rentabelli issiqxona loyihalarini amalga oshirish bo&apos;yicha hamkorlik taklif qiladi
          </p>
        </div>
          ...
          <div className="relative">
            <div className="bg-card rounded-3xl p-8 lg:p-10 border border-border shadow-xl">
              <div className="inline-flex items-center gap-2 bg-primary/10 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-primary text-sm font-medium">Yuqori daromad</span>
              </div>
              ...
              <p className="text-muted-foreground mb-8">
                Batafsil ma&apos;lumot va moliaviy modellar uchun bizning investor 
                prezentatsiyasini yuklab oling yoki mutaxassislarimiz bilan bog&apos;laning.
              </p>
