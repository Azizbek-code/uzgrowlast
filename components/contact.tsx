...
const contactInfo = [
  ...
  },
  {
    icon: MapPin,
    label: "Manzil",
    value: "Toshkent sh. Yangihaytski tumani, Fayzli MFY, Rayhon ko'chasi 107-uy",
    href: "#",
...
export function Contact() {
  ...
  return (
    <section id="aloqa" className="py-20 lg:py-32 bg-muted/30 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Savollaringiz bo&apos;lsa yoki konsultatsiya olmoqchi bo&apos;lsangiz, bizga murojaat qiling
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-card rounded-2xl p-6 border border-border">
              <h3 className="text-xl font-bold text-foreground mb-6">Kontakt ma&apos;lumotlari</h3>
              <div className="space-y-5">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-medium text-foreground group-hover:text-primary transition-colors">{info.label}</h4>
          ...
          <div className="lg:col-span-3">
            <div className="bg-card rounded-2xl p-8 border border-border shadow-lg">
              <h3 className="text-2xl font-bold text-foreground mb-2">Bepul konsultatsiya oling</h3>
              <p className="text-muted-foreground mb-8">Ma&apos;lumotlaringizni qoldiring va mutaxassisimiz siz bilan bog&apos;lanadi</p>
              ...
              {isSubmitted ? (
                <div className="text-center py-12">
                  ...
                  <h4 className="text-xl font-bold text-foreground mb-2">Rahmat!</h4>
                  <p className="text-muted-foreground">Arizangiz qabul qilindi. Tez orada siz bilan bog&apos;lanamiz.</p>
                </div>
              ) : (
