...
import { Building2, Settings, Cpu, Users, ArrowRight, Check } from "lucide-react"
...
const services = [
  {
    ...
    description: "Biz to'liq sikl asosida issiqxona quramiz. Natija: energiya tejamkor, yuqori hosildorlikka ega zamonaviy issiqxona.",
    features: [
      "Metall konstruksiya",
  ...
  },
  {
    ...
    description: "Biz har bir kvadrat metrni rentabelli ishlashini ta'minlaymiz. Har bir loyiha individual hisoblanadi.",
    features: [
  ...
  },
  {
    ...
    description: "Eng zamonaviy va energiya tejamkor jihozlar bilan ta'minlaymiz.",
    features: [
      "Isitish tizimi",
  ...
  },
  {
    ...
    description: "Biz faqat qurmaymiz - natijaga olib chiqamiz. Rentabellik tahlili va biznes model ishlab chiqiladi.",
    features: [
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            To&apos;liq sikl agro-injiniring yechimlari - loyihalashdan to tayyor hosilgacha
          </p>
        </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <ArrowRight className={cn(
                    ...
                    activeService === index ? "text-white translate-x-1" : "text-muted-foreground"
                  )} />
                </div>
              </button>
            ))}
            ...
            <div className="aspect-video bg-gradient-to-br from-primary/20 to-primary/5 relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-muted-foreground">
                  ...
                  <p className="text-sm">Rasm joylash uchun joy</p>
                  <p className="text-xs opacity-60">{services[activeService].image}</p>
                </div>
              </div>
            </div>
