        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3">
              <img
                src="/images/logo.png"
                alt="UZ GROW Logo"
                className="w-24 h-24 rounded-xl object-contain shadow-lg animate-logo"
              />
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === item.href
                      ? "text-primary bg-[#24B14B]/10"
                      : "text-gray-900 hover:text-primary hover:bg-[#24B14B]/5",
                  )}
                >
                  {item.label}
                </Link>
              ...
              <Button
                ...
                className={cn(
                  ...
                  showTransparent
                    ...
                    : "bg-[#24B14B] hover:bg-[#24B14B]/90 text-primary-foreground",
                )}
              >
                Bepul konsultatsiya
              </Button>
          ...
          >
            <div className="bg-background rounded-2xl p-4 shadow-xl">
                ...
                {navItems.map((item) => (
                  <Link
                    ...
                    className={cn(
                      ...
                      pathname === item.href
                        ? "text-primary bg-[#24B14B]/10"
                        : "text-foreground hover:text-primary hover:bg-[#24B14B]/5",
                    )}
                  >
                    {item.label}
                  </Link>
              ...
              {/* <div className="mt-4 pt-4 border-t border-border">
                <Button className="w-full bg-[#24B14B] hover:bg-[#24B14B]/90 rounded-full">
                  Bepul konsultatsiya
                </Button>
              </div> */}
            </div>
