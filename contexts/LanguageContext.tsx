  ...
  uz: {
    ...
    team: {
      ...
      members: {
        ...
        jamshid: {
          name: "Jamshidbek Toshmatov",
          position: "Loyihalar Menejeri",
          bio: "Issiqxona loyihalarini boshqarish va nazorat qilish bo'yicha mutaxassis. 5+ yillik tajriba bilan yirik va kichik loyihalarni muvaffaqiyatli yakunlash.",
          experience: "5+ yillik",
          achievements: [
          ...
          education: ["Qurilish injeneri", "Loyihalash"],
          skills: [
            "Loyihalash",
            "AutoCAD",
            "3D modellashtirish",
        ...
        bobur: {
          name: "Boburjon Karimov",
          position: "Moliya Menejeri",
          bio: "Kompaniya moliyaviy faoliyatini boshqarish va byudjetni rejalashtirish bo'yicha mutaxassis. 8+ yillik tajriba bilan moliyaviy barqarorlikni ta'minlaydi.",
          experience: "8+ yillik",
          achievements: [
        ...
        azamat: {
          ...
          bio: "Issiqxona va jihozlar sotuvi bo'yicha mutaxassis. 6+ yillik tajriba bilan mijozlar bazasini kengaytirish va yangi bozorlarni o'rganish.",
          experience: "6+ yillik",
          achievements: [
            "100+ shartnoma",
            "Mijozlar bazasi kengayishi",
            "Yangi bozorlarni o'rganish",
          ],
          education: ["Marketing", "Sotuv"],
          skills: [
            "Sotuv strategiyasi",
