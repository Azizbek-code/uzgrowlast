...
const translations = {
    ...
    about: {
      ...
      valuesAndRules: {
        ...
        rules: [
          ...
          "Ishda, muloqotda va qaror qabul qilishda halol bo'lish shart. Yolg'on ma'lumot berish, hujjatlarni soxtalashtirish, resurslardan shaxsiy foydalanish taqiqlanadi.",
          "",
          "2. O'zaro hurmat va ochiq muloqot",
          "Hamkasblariga, rahbariyatga va mijozlarga hurmat bilan munosabatda bo'lish shart. Muammo va takliflarni ochiq, odobli va konstruktiv tarzda bildirish kerak.",
          "",
          "3. Jamoviy rivojlanish",
          "Jamoaning umumiy muvaffaqiyatiga hissa qo'shish kerak. Jamoada bilim, tajriba va mahorat almashinuvi targ'ib qilinadi.",
          "",
          "4. Xiyonatsizlik – ishonchning asosi",
          "Kompaniya manfaatlariga va sir saqlash siyosatiga xiyonat qilish qattiq man etiladi. Maxfiy ma'lumotlarni himoya qilish shart.",
          "",
          "5. Yangi fikrlarga va o'zgarishlarga ochiqlik",
          "O'zgarishlar – bu taraqqiyot garovidir. Yangi metodlar va texnologiyalarni o'rganishga tayyor bo'lish kerak. Innovatsion takliflar rag'batlantiriladi.",
          "",
          "6. Mas'uliyat va o'z vaqtida bajarish",
          "Topshiriqlarni o'z vaqtida, sifatli bajarilishi kerak. Kechikishlar va e'tiborsizlik jamoaning umumiy samaradorligiga salbiy ta'sir qiladi.",
          "",
          "7. Tozalik va tartib",
          "Ish joyi – bizning ikkinchi uyimiz. Uni toza, ozoda va xavfsiz saqlash har birimizning burchimi. Jamoaviy sanitar kunlari belgilangan holda o'tkaziladi.",
          "",
          "8. Ustoz-shogirdlik ruhida ishlash",
          'Tajribali xodimlar yangilariga yordam berishi, ularga ishni tushuntirishi tavsiya etiladi. "Bir-birini o\'rgatish" madaniyati rivojlantiriladi.',
          "",
          "9. Ichki madaniyat va kiyinish tartibi",
          "Kompaniya obro'sini yuksak tutish, o'ziga va boshqalarga madaniyatli munosabatda bo'lish kerak. Kiyinish tartibiga amal qilinadi.",
          "",
          "10. Mijozga hurmat – kompaniya sha'nidir",
          "Mijozlar bilan odobli, hurmatli va ijobiy muloqot kerak. Har bir mijoz – kompaniyamizning obro'sini aks ettiruvchi ko'zgudir. Shikoyatlarni darhol rahbariyatga yetkazish majburiy.",
        ],
      },
    },
    services: {
  ...
  ru: {
    ...
    about: {
      ...
      clients: "Клиенты",
      countries: "Страны",
      values: ["Качество", "Инновации", "Доверие", "Долгосрочное партнёрство"],
      tagline: "О нас",
      ...
      mission: "Миссия",
      missionDesc:
        "Увеличение доходов клиентов через реализацию устойчивых и рентабельных тепличных проектов, соответствующих местным и международным стандартам.",
      vision: "Видение",
      visionDesc:
    ...
    team: {
      ...
      members: {
        ...
        abdulloh: {
          name: "Абдуллох Шералиевич",
          position: "Технический Директор",
          bio: "Специалист по строительству теплиц и технологиям. Внедряет современные агротехнологии с опытом более 10 лет.",
          experience: "10+ лет",
          achievements: [
    ...
    greenhouse: {
      ...
      polikarbanat: {
        ...
        description:
          "Усовершенствованный поликарбонат, превосходная теплоизоляция. Идеально для круглогодичного выращивания.",
        features: [
    ...
    contact: {
      ...
      address:
        "г. Ташкент, Янгихаётский район, МФЙ Файзли, ул. Райхон, дом 107",
      companyPhone: "+998555152223",
      companyPhone2: "+998994352313",
      companyEmail: "uzgrrow@gmail.com",
      website: "https://www.uzgrow.uz/",
    ...
    footer: {
      ...
      links: {
        services: [
          ...
          { label: "Строительство", href: "/qurilish" },
        ],
        company: [
  ...
  en: {
    ...
    greenhouse: {
      ...
      polikarbanat: {
        ...
        description:
          "Advanced polycarbonate, excellent insulation. Perfect for year-round cultivation.",
        features: [
    ...
    contact: {
      ...
      address:
        "Tashkent city, Yangihayot district, Fayzli MFY, Rayhon street, 107",
      companyPhone: "+998555152223",
      companyPhone2: "+998994352313",
      companyEmail: "uzgrrow@gmail.com",
      website: "https://www.uzgrow.uz/",
    ...
    footer: {
      ...
      links: {
        services: [
          ...
          { label: "Construction", href: "/qurilish" },
        ],
        company: [
