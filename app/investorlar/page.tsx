...
const benefits = [
  {
    ...
    title: "Yuqori ROI",
    description:
      "Issiqxona loyihalarida yuqori ichki rentabellik darajasi (IRR) va tez qaytim.",
  },
  {
    icon: BarChart3,
    title: "Tez aylanma",
    description:
      "Yil davomida bir necha marta hosil olish imkoniyati va tez aylanuvchi mahsulot.",
  },
  {
    icon: Shield,
    title: "Oziq-ovqat xavfsizligi",
    description:
      "O'zbekistonda oziq-ovqat xavfsizligini ta'minlashga hissa qo'shish.",
  },
  {
    icon: Globe,
    title: "Eksport salohiyati",
    description:
      "Xalqaro bozorlarga eksport qilish imkoniyati va valyuta daromadi.",
  },
  {
    icon: Leaf,
    title: "ESG yondashuv",
    description:
      "Ekologik, ijtimoiy va boshqaruv standartlariga mos investitsiya.",
  },
];
      ...
      <section className="py-20 bg-[#24B14B]">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-primary-foreground/80 text-lg mb-8 max-w-2xl mx-auto">
            Bizning mutaxassislarimiz sizga eng mos investitsiya modelini
