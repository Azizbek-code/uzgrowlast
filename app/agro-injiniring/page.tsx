...
export const metadata = {
  ...
  description: 'UZ-GROW agro-injiniring xizmatlari. Zamonaviy qishloq xo\'jaligi texnologiyalari, avtomatlashtirish tizimlari va samarali yechimlar.',
  keywords: 'UZ-GROW agro-injiniring, qishloq xo\'jaligi texnologiyalari, avtomatlashtirish, gidroponik, issiqxona texnologiyalari',
  openGraph: {
    title: 'Agro-injiniring - UZ-GROW | Zamonaviy qishloq xo\'jaligi yechimlari',
    description: 'UZ-GROW agro-injiniring xizmatlari. Zamonaviy qishloq xo\'jaligi texnologiyalari va avtomatlashtirish tizimlari.',
...
const agroServices = [
  ...
  },
  {
    ...
    description: "Harorat, namlik va CO2 ni avtomatik nazorat qilish tizimlari",
    features: ["Temperature Control", "Humidity Management", "CO2 Systems", "Ventilation"],
    color: "bg-orange-500"
  },
  {
...
const technologies = [
  {
    name: "IoT Sensorlar",
    description: "Harorat, namlik, yorug'lik va tuproq namligini o'lchaydigan zamonaviy sensorlar",
    icon: <Wind className="w-6 h-6" />
  },
  {
    name: "Cloud Platform",
    description: "Barcha ma'lumotlarni bulutda saqlash va uzoqdan boshqarish imkoniyati",
    icon: <Cloud className="w-6 h-6" />
  },
  {
    name: "AI Analytics",
    description: "Sun'iy intellekt yordamida hosildorlikni bashorat qilish va optimal yechimlar",
...
const benefits = [
  {
    ...
    description: "Zamonaviy texnologiyalar yordamida hosildorlik 30-50% ga oshadi",
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {agroServices.map((service, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg">
                <CardHeader>
                  <div className={`w-16 h-16 ${service.color} rounded-2xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform`}>
                    {service.icon}
                  </div>
