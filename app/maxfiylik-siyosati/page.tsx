...
export const metadata = {
  ...
  description: 'UZ-GROW maxfiylik siyosati. Shaxsiy ma\'lumotlaringizni qanday to\'playmiz, qanday maqsadda ishlatamiz va qanday himoya qilamiz.',
  keywords: 'UZ-GROW maxfiylik siyosati, shaxsiy ma\'lumotlar, GDPR, ma\'lumotlarni himoya qilish, cookies',
  openGraph: {
    title: 'Maxfiylik siyosati - UZ-GROW | Ma\'lumotlarni himoya qilish',
    description: 'UZ-GROW maxfiylik siyosati. Shaxsiy ma\'lumotlaringizni qanday to\'playmiz va himoya qilamiz.',
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                UZ-GROW sifatida biz sizdan quyidagi shaxsiy ma'lumotlarni to'plamiz:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mt-4">
                ...
                <li>Ijtimoiy tarmoqlardagi profilingiz ma'lumotlari (faqat izoh bilan)</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2 mt-4">
                ...
                <li>Marketing va reklama maqsadlarida (faqat roziligiz bilan)</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Biz sizning shaxsiy ma'lumotlaringizni quyidagilar bilan bo'lishishimiz mumkin:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mt-4">
                <li>Hamkor kompaniyalar va pudratchilar (loyiha ijrosi uchun)</li>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-700">
                    <strong>Eslatma:</strong> Biz hech qachon sizning shaxsiy ma'lumotlaringizni 
                    uchinchi shaxslarga sotmaymiz yoki qonunga zid ravishda ulashmaymiz.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Biz sizning ma'lumotlaringizni quyidagi muddatlar davomida saqlaymiz:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2 mt-4">
                <li>Kontakt ma'lumotlari - shartnoma muddati davomida + 5 yil</li>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Huquqlaringiz</h2>
              <p className="text-gray-600 leading-relaxed">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2 mt-4">
                ...
                <li>Ma'lumotlarni o'chirish huquqi (ma'lum shartlar asosida)</li>
            ...
            <div className="bg-blue-50 rounded-2xl p-8 border border-blue-200">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">7. Aloqa ma'lumotlari</h2>
              <p className="text-blue-800 leading-relaxed">
                Maxfiylik siyosati bo'yicha savollaringiz bo'lsa, biz bilan quyidagi manzillar orqali bog'laning:
              </p>
              <div className="mt-4 space-y-2 text-blue-800">
                <p><strong>Email:</strong> privacy@uzgrow.uz</p>
                <p><strong>Telefon:</strong> +998 88 435-23-13</p>
                <p><strong>Manzil:</strong> Toshkent sh. Rayhona ko'chasi 107-uy</p>
              </div>
            </div>
          </div>
        </div>
